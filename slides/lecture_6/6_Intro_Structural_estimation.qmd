...
format:
  revealjs: 
    output-file: ACE592_6_slides.html
    ...
    chalkboard:
      ...
      chalk-effect: 0.1
  html:
    output-file: ACE592_6_notes.html
    toc: false
...
- In Julia, the `DataFrames` package offers interface to work with data tables
  ...
  - If you haven't done so yet, please read and follow the steps in [this tutorial](https://julia.school/julia/dataframes)
