...
![](figures/Armijo.png){fig-align="center"}
...
::: {.columns}
::: {.column}
Using default configurations in solvers, you may have notice sometimes they use `Trust region with dogleg`. What is that?
